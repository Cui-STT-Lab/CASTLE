...
class Encoder(Module):
    def __init__(self, in_features, out_features, graph_neigh, graph_neigh_a=None, dropout=0.0, act=F.relu):
        super(Encoder, self).__init__()
        self.in_features = in_features
        self.out_features = out_features
        self.graph_neigh = graph_neigh
        self.graph_neigh_a = graph_neigh_a
    ...
    def forward(self, feat, feat_a, adj, adj_a=None):
        ...
        if self.graph_neigh_a is not None:
            g_a = self.read(emb_a, self.graph_neigh_a)
        else:
